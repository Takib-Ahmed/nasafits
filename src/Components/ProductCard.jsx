...
export default function ProductCard({key,cover,name,mainPrice,discountPrice,save,className}){
    return (
            <div key={key} className={`Productcard   pt-0.5 sm:pb-1  grid shadow-lg lg:w-auto gap-0.5 saleproduct bg-white     border-1  rounded-lg  overflow-hidden ${className}`}>
                      ...
                      ">
                        <div className="bg-gray-700 text-white w-24   rounded overflow-hidden ">Tk.{save}</div>
                      </div>
